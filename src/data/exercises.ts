...
export const EXERCISES: Exercise[] = [
  ...
  { id: 'extension_cuadriceps', name: 'Extensión de cuádriceps en máquina', primary: 'cuadriceps_gluteo', secondary: [], equipment: ['maquina_extension'], stress: 'bajo', loadFactor: 0.4 },
